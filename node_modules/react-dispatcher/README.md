This repo is an [npm](https://www.npmjs.org/)-installable version of the `Dispatcher` in [facebook/flux](https://github.com/facebook/flux), forked from the original repo with no modifications made to the source. To use it, just `npm install react-dispatcher` and:
