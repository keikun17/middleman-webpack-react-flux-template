...
function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) subClass.__proto__ = superClass;} // var HeatsinkStore = require("./stores/heatsink_store")
var _storesHeatsink_storeJsx = require("./stores/heatsink_store.jsx");var _storesHeatsink_storeJsx2 = _interopRequireDefault(_storesHeatsink_storeJsx);var _storesHeat_store = require("./stores/heat_store");var _storesHeat_store2 = _interopRequireDefault(_storesHeat_store);var _actionsHeat_actions = require("./actions/heat_actions");var _actionsHeat_actions2 = _interopRequireDefault(_actionsHeat_actions);var _storesMap_store = require("./stores/map_store");var _storesMap_store2 = _interopRequireDefault(_storesMap_store);var _constantsMap_constants = require("./constants/map_constants");var _constantsMap_constants2 = _interopRequireDefault(_constantsMap_constants);var _storesCooldown_store = require(
"./stores/cooldown_store");var _storesCooldown_store2 = _interopRequireDefault(_storesCooldown_store);var _gauge = require(
"./gauge");var _gauge2 = _interopRequireDefault(_gauge);var React = require("react");var 
...
CurrentHeat = (function (_React$Component) {
  ...
  function CurrentHeat(props) {_classCallCheck(this, CurrentHeat);
    ...
    function componentDidMount() {
      this.store_data = _storesHeatsink_storeJsx2["default"].get_new_data();
